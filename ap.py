...
<style>
    /* ================= 1. KHÓA CUỘN TRÌNH DUYỆT VÀ ẨN MỌI THANH CUỘN ================= */
    html, body {
    ...
    * { scrollbar-width: none !important; -ms-overflow-style: none !important; }
    ...
    section[data-testid="stSidebar"] {
        ...
        /* SIDEBAR: Cách mép trái 20px, trên 60px, dưới 60px */
    ...
    .stMainBlockContainer, .block-container, [data-testid="stAppViewBlockContainer"] { 
        ...
        /* KHỐI CHÍNH: Cách Sidebar đúng 10px, Cách mép phải 20px */
        margin-top: 60px !important;     
        margin-bottom: 60px !important;  
        margin-left: 10px !important;  /* CHÍNH XÁC KHOẢNG HỞ 10PX Ở ĐÂY */
    ...
    /* Thanh cuộn mượt mà riêng cho nội dung bảng */
