...
with st.sidebar:
    ...
    st.markdown("<h3 style='text-align: left; margin-top: 5px; margin-bottom: 15px; color: #0f172a; font-size: 15px;'>BỘ LỌC DỮ LIỆU</h3>", unsafe_allow_html=True)
...
# ----------------- ĐÃ ĐỔI ĐỘ ĐẬM (FONT-WEIGHT) XUỐNG 600 -----------------
st.markdown("""
